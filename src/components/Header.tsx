          ...
          <div className="max-w-7xl mx-auto px-6 py-8">
            <div className="grid grid-cols-12 gap-8">
              ...
              <div className="col-span-2">
                ...
                <ul className="space-y-3">
                  <li><Link to="/recruitment" className="text-gray-700 hover:text-gray-900 text-sm font-medium transition-colors">Counter Strike 2</Link></li>
                  ...
                  <li><Link to="/recruitment" className="text-gray-700 hover:text-gray-900 text-sm font-medium transition-colors">Apex Legends</Link></li>
                  <li><Link to="/recruitment" className="text-gray-700 hover:text-gray-900 text-sm font-medium transition-colors">Rocket League</Link></li>
...
>>>>>>> a45c5447fb0db915367df1aaea32ac002359a831
